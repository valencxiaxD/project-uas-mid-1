...
from PyQt5.QtWidgets import QApplication, QFileDialog, QWidget, QLabel, QLineEdit, QPushButton, QGridLayout, QTableWidget, QTableWidgetItem, QComboBox, QMessageBox, QStackedWidget, QHBoxLayout, QVBoxLayout,QHeaderView, QFrame
    ...
    def proses_pembayaran(self):
        ...
        if msg.clickedButton() == btn_download:
            filename, _ = QFileDialog.getSaveFileName(
                self,
                "Simpan Struk",
                f"struk_{result['nomor_struk']}.pdf",
                "PDF File (*.pdf)"
            )
            ...
            if filename:
                try:
                    ...
                    c.save()
                    QMessageBox.information(self, "Berhasil", "Struk PDF berhasil disimpan")
                except Exception as e:
