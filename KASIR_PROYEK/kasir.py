...
class GUILogin(QWidget):
    ...
    def setup_layout(self):
        ...
        self.button_signup = QPushButton("Belum punya akun? Daftar")
...
class GUIKasir(QWidget):
    ...
    def setup_layout(self):
        ...
        self.jumlah_le = QLineEdit()
        self.jumlah_le.setPlaceholderText("Masukkan jumlah barang")
    ...
    def proses_pembayaran(self):
        ...
        if result["status"]:
            ...
            QMessageBox.information(self, "Transaksi Berhasil", 
                                   f"Nomor Struk: {result['nomor_struk']}\n\n{struk}")
            self.refresh_table()
            self.update_total()
